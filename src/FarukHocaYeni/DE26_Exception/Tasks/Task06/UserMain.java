package FarukHocaYeni.DE26_Exception.Tasks.Task06;
...
public class UserMain {
    public static void main(String[] args) {
        ArrayList<j26_Exceptions.Tasks.Task06.User> kullanicilar=new ArrayList<>();
        int kullanici = 0;
      ...
      // } while (kullanici <2);
         ...
         boolean usernameIste = true;
            ...
            password = oku.nextLine();
            try {
                j26_Exceptions.Tasks.Task06.User yeniUser = new j26_Exceptions.Tasks.Task06.User(username, password);
                kullanicilar.add(yeniUser);
                kullanici++;
