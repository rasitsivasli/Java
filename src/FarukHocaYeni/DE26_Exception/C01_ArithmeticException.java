...
public class C01_ArithmeticException {//Class level
    ...
    public static void main(String[] args) {//main  meth. level
        ...
        } catch (ArrayIndexOutOfBoundsException ebikgabik) {
            System.out.println("Agam niddin olmayan array elelmanı istirsen :( ");
            System.out.println("Agam 2. catch blok'dan selamkeee");
        } catch (Exception falanFilan) {//Exception Class g parent:Hz.ADEM: butun axception kapsayan exception class->bad practice
            // hata yakalandıgında yapılacak aksiyonların oldugu block

            //Exception-> olusan hata Data type
            //falanFilan-> java'nın olusan exception'a atayacagı obj name best parctice:e
        ...
        System.out.println("AGAM bu printi okuduysan app. gayet başarılı dewamkeee");//pr sonuna kadar çalıştı mesaj
