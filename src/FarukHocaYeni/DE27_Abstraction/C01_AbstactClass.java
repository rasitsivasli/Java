package FarukHocaYeni.DE27_Abstraction;

public class C01_AbstactClass {
    ...
    4- Abs method sadece abs Class'da tanımlanabilir kesinlikle concrete class'da abs method tanımlanamaz.->fani dunyalı vuucudu görünmex soyut olamaz
            ama abs class'da concerete(abstract olmayan yani gövdeli) emthod tanımlanabilir.->melekler isterse dunyalıya fiziken görünebilir.
