...
public class Q03_tekrarBak {
    public static void main(String[] args) {
        ...
        System.out.println(((yil2-yil1)*365+(ay2-ay1)*30+(gun2-gun1)+" gündür"));
//
//        int toplamGun = (yil2-yil1)*365+(ay2-ay1)*30+(gun2-gun1);
//
//        int sonTarihyil =toplamGun/365;
//        int sonTarihay = sonTarihyil;
//        int sonTarihgun = ((yil2-yil1)*365+(ay2-ay1)*30+(gun2-gun1))/365;
