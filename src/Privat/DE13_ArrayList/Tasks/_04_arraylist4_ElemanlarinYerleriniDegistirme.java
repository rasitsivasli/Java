...
public class _04_arraylist4_ElemanlarinYerleriniDegistirme {
    ...
    private static ArrayList<String> changeInArraylist(ArrayList<String> arrayList, String s1, String s2) {
        for (int i = 0; i < arrayList.size(); i++) {
            if ("blue".equals(arrayList.get(i))){
                arrayList.set(i,"yellow");
            }
        }
