package Privat.DE06_SwitchCase;
...
public class C06_SwitchCase {
    public static void main(String[] args) {
        ...
        switch(gun) {
            ...
            case "salı":
            case "çarşamba":
            case "perşembe"://yukarıdaki tüm case'ler aynı aksiyonu alacagı için break atılmadı
            case "cuma":
        ...
        System.out.println("agam  code gayet başarılı run olup switch  blok'tan çıkmıştır. DEWAMKEEE...");
