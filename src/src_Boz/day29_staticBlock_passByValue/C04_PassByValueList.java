...
public class C04_PassByValueList {
	...
	public static void main(String[] args) {
		...
		System.out.println("ClassMain Method'a donunce list : " + harfler); // [D, B, C]
		...
		System.out.println("list'e yeni list atadiktan sonra ClassMain Method'a donunce list : " + harfler); // [D, B, C]
